...
// 加载字段
const loadFields = () => {
  fields.value = getModuleFields(props.module)
}
    ...
    <div class="field-list">
      ...
      >
        ...
        <span class="col-actions">
          ...
          <el-button link type="danger" size="small" :disabled="field.required" @click="handleDelete(field)">
