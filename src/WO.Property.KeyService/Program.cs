...
using WO.Property.KeyService.Middleware;
...
builder.Services.AddSingleton<WO.Property.KeyService.Tenant.ITenantDbFactory, WO.Property.KeyService.Tenant.TenantDbFactory>();
builder.Services.AddScoped<IDbContextFactory<TenantDbContext>>(sp =>
    new TenantDbContextFactory(
        sp.GetRequiredService<WO.Property.KeyService.Tenant.ITenantDbFactory>(),
...
Console.WriteLine("  Port: 5512 (Phase 1 multi-tenant)");
Console.WriteLine("===========================================");
