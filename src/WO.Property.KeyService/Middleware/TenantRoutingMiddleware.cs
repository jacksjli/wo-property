...
namespace WO.Property.KeyService.Middleware;
...
public class TenantRoutingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, WO.Property.KeyService.Tenant.ITenantDbFactory tenantDbFactory)
    {
