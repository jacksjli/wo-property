...
namespace WO.Property.FinanceService.Middleware;
...
public class TenantRoutingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, WO.Property.FinanceService.Tenant.ITenantDbFactory tenantDbFactory)
    {
