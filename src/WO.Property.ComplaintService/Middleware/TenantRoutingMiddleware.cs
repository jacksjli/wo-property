...
namespace WO.Property.ComplaintService.Middleware;
...
public class TenantRoutingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, WO.Property.ComplaintService.Tenant.ITenantDbFactory tenantDbFactory)
    {
