...
namespace WO.Property.StatisticsService.Middleware;
...
public class TenantRoutingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, WO.Property.StatisticsService.Tenant.ITenantDbFactory tenantDbFactory)
    {
