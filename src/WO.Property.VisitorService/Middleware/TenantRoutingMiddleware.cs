...
namespace WO.Property.VisitorService.Middleware;
...
public class TenantRoutingMiddleware
{
    ...
    public async Task InvokeAsync(HttpContext context, WO.Property.VisitorService.Tenant.ITenantDbFactory tenantDbFactory)
    {
